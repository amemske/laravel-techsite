                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('update.blog') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" value="{{$blog->blog_title}}"  name="blog_title" id="portfolio_title">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text"  name="blog_tags" value="{{$blog->blog_tags}}" data-role="tagsinput">
                                        @error('portfolio_title')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded-circle avatar-xl" alt="200x200" src="{{ asset($blog->blog_image)}}" data-holder-rendered="true">
                                    </div>
                                </div>
