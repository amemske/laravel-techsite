            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title pb-4">Edit Portfolio Page</h4>
...
<input type="hidden" name="id" value="{{$portfolio->id}}">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control"  value="{{$portfolio->portfolio_name}}" type="text"  name="portfolio_name" id="portfolio_name ">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" value="{{$portfolio->portfolio_title}}" type="text"  name="portfolio_title" id="portfolio_title">
...
{{$portfolio->portfolio_description}}
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded-circle avatar-xl" alt="200x200" src="{{ asset($portfolio->portfolio_image)}}" data-holder-rendered="true">
                                    </div>
                                </div>

                                <input type="submit" class="btn btn-info waves-effect waves-light" value="edit Portfolio Data">
                            </form>
                        </div>
                    </div>
