            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title pb-4">Update Multi Image Page</h4>
                            <form method="post" action="{{ route('update.multi.image') }}" enctype="multipart/form-data">
                                @csrf
                                <input class="form-control" name="id" type="hidden" value="{{$multiImage->id}}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded-circle avatar-xl" alt="200x200" src="{{ asset($multiImage->multi_image)}}" data-holder-rendered="true">
                                    </div>
                                </div>
